...
{ pkgs, fetchurl, fetchhg }: let
  python = pkgs.python311;
  pythonpkgs = pkgs.python311Packages;
in rec {
  "Pillow" = pythonpkgs.buildPythonPackage rec {
    pname = "Pillow";
    version = "10.0.0";
    src = fetchurl {
  ...
  # "numpy" = pythonpkgs.buildPythonPackage rec {
  #   pname = "numpy";
  #   version = "1.26.2";
  #   src = fetchurl {
  ...
  #   ];
  # };
  "opencv-python" = pythonpkgs.buildPythonPackage rec {
    pname = "opencv-python";
    version = "4.5.5.62";
    src = fetchurl {
  ...
  "pyserial" = pythonpkgs.buildPythonPackage rec {
    pname = "pyserial";
    version = "3.5";
    src = fetchurl {
  ...
  "shxparser" = pythonpkgs.buildPythonPackage rec {
    pname = "shxparser";
    version = "0.0.2";
    src = fetchurl {
  ...
  "svgelements" = pythonpkgs.buildPythonPackage rec {
    pname = "svgelements";
    version = "1.9.5";
    src = fetchurl {
